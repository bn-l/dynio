...
declare module '$env/static/private' {
	...
	export const BETTER_EXCEPTIONS: string;
	...
	export const GENERIC_DEV_STATE: string;
	...
	export const NODE_INSPECT_RESUME_ON_START: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		NODE: string;
		NODE_EXE: string;
		NODE_INSPECT_RESUME_ON_START: string;
		NPM_CLI_JS: string;
		npm_command: string;
